...
export const Contact = () => {
  ...
  return (
    ...
    >
      <RevealOnScroll>
        <div className="px-4 w-full min-w-[300px] md:w-[500px] sm:w-2/3 backdrop-blur-sm p-6 gap-10">
          <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-cyan-500 to-red-400 bg-clip-text text-transparent text-center">
            {" "}
            Get In Touch
          </h2>
